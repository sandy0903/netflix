...
const Hero = ({text,borderBottom}) => {
  return (
    <div className={borderBottom ? "w-full h-screen overlay-shadow relative top-[-90px] z-[5] border-b-8 border-slate-800  " : "w-full h-[150vh] overlay-shadow relative top-[-90px] z-[5] " }>
        ...
        <div className="text-center absolute top-[30%] z-[100] right-0 left-0 w-full">
            {
                ...
                <h1 className=" text-2xl md:text-4xl lg:text-5xl font-bold sm:w-[80%] mx-auto ">
                  Chương trình truyền hình,  phim không giới hạn và nhiều nội dung
                  khác.
                </h1>
                <p className="text-sm sm:text-[1.7rem] my-4">
